<?php /* Smarty version 2.6.6, created on 2012-05-13 20:50:44
         compiled from lurajcevi_02_osobno.tpl */ ?>
...
<div id = 'sadrzaj'> 
			<div class= "about_container">
					...
					<ul class = "popis_2" >
						...
						<li class = "items2"> <b>Datum rođenja: </b> 16. 07. 1990.</li>
						<li class = "items2"> <b>Mjesto rođenja: </b> Slavonski Brod </li>
						<li class = "items2"> <b>Grupa na vježbama:</b> 1 </li>
						<li class = "items2"> <b>Tema seminara:</b> DOM - Document Object Model</li>
					...
					<img src = "pictures/lurajcevi_slika.jpg" alt = "Moja slika" class = "floater"/>
