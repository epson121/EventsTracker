<?php /* Smarty version 2.6.6, created on 2012-06-02 12:51:52
         compiled from adressPaging.tpl */ ?>
...
?>
			<tr>
				<form method = 'post' name = 'from12' action = '<?php echo $this->_tpl_vars['action']; ?>
'>
				<td><input type = "text" name = "adress" value = "<?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['adresa']; ?>
"/>
				<input type = "hidden" name = 'idAddress' value = "<?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['id_adresa']; ?>
"/>
